# Weather-App
> Pure  vanilla HTML, CSS and JavaScript weather app website by fetching temperature through free Weather API.

# Weather-App Demo
<!-- Replace "link-to-demo.gif" with a link to a demo GIF or screenshot of the app -->
...
#Demo
The live demo of the Weather-App here. <!-- Replace "link-to-live-demo" with the URL to the live demo if available -->
